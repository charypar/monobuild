...
$ mononobuild print -f ./dependencies.monobuild --dependencies --dot
```

The file can be created with the `print` command itself, which will collect the
manifests and produce the full map.s
...
On CI a useful check to run once you have a checkout of the repo is

```
$ monobuild print --full > dependencies.test.monobuild
$ cmp dependencies.monobuild dependencies.test.monobuild
```
